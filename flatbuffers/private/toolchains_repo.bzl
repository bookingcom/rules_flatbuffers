...
# By default all these toolchains are registered by the flatbuffers_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:flatbuffers_toolchain",
    toolchain_type = "@com_bookingcom_rules_flatbuffers//flatbuffers:toolchain_type",
)
""".format(
            platform = platform,
